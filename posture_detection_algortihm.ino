...
//___________________________________________________SETUP_____________________________________________________________
void setup()
{
  Serial.begin(115200);
...
void loop() {
  ...
  //str =String("coming from arduino: ")+String("Heel= ")+String(h)+String("T= ")+String(t);
